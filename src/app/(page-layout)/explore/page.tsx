...
function Explore({ searchParams }: ExploreProps): JSX.Element | null {
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="flex items-center gap-3 overflow-x-auto pb-1 scrollbar-thin scrollbar-track-app-gray-600 scrollbar-thumb-app-gray-700 scrollbar-thumb-rounded scrollbar-track-rounded">
