interface StarOutlineIconProps extends React.ComponentPropsWithoutRef<"svg"> {
  size?: number;
}
...
export function StarOutlineIcon({
  size = 32,
  ...props
}: StarOutlineIconProps): JSX.Element | null {
  return (
    <svg
      width={size}
      height={size}
